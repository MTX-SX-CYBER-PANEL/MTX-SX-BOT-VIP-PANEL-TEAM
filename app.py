...
BOT_TOKEN = "8578341436:AAGYcgWfVlk3CJRRFHpgbBXyCXI9Cm68XXE"
DEV_IDS = [7375963526]
TEAM_NAME = "MTX SX TEAM BOT"
REPO_NAME = "MTX SX BOT VIP PANEL TEAM"
...
def check_banned_status(player_id):
    ...
    url = f"https://api.mtx-sx-team-bot.com/check_banned?player_id={player_id}"
    try:
...
[B][C][00FF00]S 1 XㅤTEAMㅤBYㅤMASRY
[ff0000]━━━━━━━━━━━━━━━━━━━━━
[B][C][FF9900]D O N EㅤH A C K I N G
[B][C][E75480]Y O U RㅤA C C O U N T
[81DACA]━━━━━━━━━━━━━━━━━━━━━
[B][C][FF0000]IㅤAM ㅤS1X	MASRY
[CCFFCC]━━━━━━━━━━━━━━━━━━━━━
[B][C][81DACA]MTX SX TEAM BOT
[FFFF00]━━━━━━━━━━━━━━━━━━━━━
[B][C][00FF00]F O L L O WㅤM EㅤI NㅤI N S T A G R A Mㅤ[FFFFFF]@MTX_SX_TEAM
[00008B]━━━━━━━━━━━━━━━━━━━━━
...
[FFD700]👑 NAME : [FFFF00]MTX SX TEAM BOT
[FFD700]📌 INSTAGRAM : [00BFFF]@MTX_SX_TEAM
[FF1493]╚══════════════════════════╝""", idinv
                            )
                    )
                    senthi = False
...
MTX SX BOT VIP PANEL TEAM COMMUNITY BOT
...
INSTAGRAM :@MTX_SX_TEAM

TELEGRAM :@MTX_SX_TEAM
...
[FF0000]╠══════════╣
[FFD700]⚡ OWNER : [FFFFFF]3MK MASRY
[FFD700]⚡ INSTAGRAM : [FFFFFF]@MTX_SX_TEAM
[FFD700]✨ Telegram : [FFFFFF]@MTX_SX_TEAM
[FF0000]╚══════════╝
[FFD700]✨ Developer —͟͞͞ </> MTX SX TEAM BOT ⚡""", uid
                            )
                        )
                    except Exception as e:
...
[FFD700]✨ Developer —͟͞͞ </> MTX SX TEAM BOT ⚡""",
                                    uid
                                )
                            )
...
with open('masry_token.txt', 'r') as file:
    data = json.load(file)
